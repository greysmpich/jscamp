  ...
  return (
    <main>
      <section>
        ...
        <form role="search" onSubmit={handleSearch}>
          <div>
            ...
            <input required type="text" name="busqueda" placeholder="Buscar empleos por título, habilidad o empresa" id="empleos-search-input" />
      ...
      <section>
        ...
        <header>
          <h2>Categorías de empleo populares</h2>
        </header>
        <div>
